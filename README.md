...
See coppertop/tests/test_pipeable.py for a fuller description and example code.

#### ranges

D style ranges in python - see coppertop/examples/format_calendar.py and coppertop/examples/tests/test_format_calendar.py
